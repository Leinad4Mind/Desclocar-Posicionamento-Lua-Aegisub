...
function create_config()
	return {
		...
		{ class="floatedit", name="move_x1", x=1, y=1, width=1, height=1, value=0.00, hint="Deslocar prmeira coordenada x de \move" },
		{ class="label", x=2, y=1, width=1, height=1, label="," },
		{ class="floatedit", name="move_y1", x=3, y=1, width=1, height=1, value=0.00, hint="Deslocar prmeira coordenada y de \move" },
